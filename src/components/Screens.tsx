...
export function Settings({
  ...
  const { currency, setCurrency, money, shortMoney } = useCurrency();
  
  return <div className="screen-body"><section className="card section-wide settings-block"><div className="card-head"><h2 className="eyebrow">{t('Make it yours')}</h2><span className="card-meta">{mode === 'empty' ? t('empty file') : t('saved on this device')}</span></div>        <div className="settings-row">
          <div>
            <div className="settings-label">{t('Currency')}</div>
